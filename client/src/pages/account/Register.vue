          ...
          <v-card-text align-center>
            <v-layout column>
              <v-flex class="text-xs-center" xs12 md6>
                ...
                <v-btn fab dark class="google-fab" :to="{ path: '/auth/google' }">
                ...
                <v-btn fab dark class="facebook-fab" :to="{ path: '/auth/facebook' }">
                ...
                <v-btn fab dark class="twitter-fab" :to="{ path: '/auth/twitter' }">
